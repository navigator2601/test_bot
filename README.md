...
├── ai                              # Пакет інтеграції ШІ (буде реалізовано в майбутньому)
...
│   ├── auth_handler.py             # Авторизація в Telethon
│   ├── __init__.py                 # Ініціалізація пакету обробників команд
│   ├── menu_handler.py             # Меню команд
│   ├── message_search_handler.py   # Пошук повідомлень
│   ├── reply_keyboard_handler.py   # Реакція на натискання кнопок 
│   ├── route_points_handler.py     # Обробник парсингу повідомлень
...
├── utils                           # Утиліти
│   ├── coordinates_converter.py    # Конвертер координат
│   ├── google_drive.py             # Модуль підключення Google Drive
